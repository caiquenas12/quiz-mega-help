...
const bancoDePerguntasCompleto = [
  ...
  { tema: "Inglês", question: "Qual é a tradução de 'Window'?", options: ["Telhado", "Porta", "Janela", "Parede"], correct: 2, tempo: 20 },
  ...
  { tema: "Inglês", question: "Qual é a tradução de 'Bird'?", options: ["Peixe", "Pássaro", "Coelho", "Cavalo"], correct: 1, tempo: 20 },
  ...
  { tema: "Inglês", question: "Qual é a tradução da frase 'What is your name'?", options: ["Onde você mora", "Quem é você", "Qual é o seu nome", "Como você está"], correct: 2, tempo: 20 },
  { tema: "Inglês", question: "Qual é a tradução da frase 'How old are you'?", options: ["Onde você está", "Qual é o seu nome", "Quantos anos você tem", "O que você faz"], correct: 2, tempo: 20 },
  { tema: "Inglês", question: "Qual é a tradução da frase 'Where do you live'?", options: ["Quem é você", "Quantos anos você tem", "Onde você mora", "O que você faz"], correct: 2, tempo: 20 },
  { tema: "Inglês", question: "Qual é a tradução da expressão 'What time is it'?", options: ["Onde você mora", "Quem é você", "Que horas são", "Como você está"], correct: 2, tempo: 20 },
